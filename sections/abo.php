						...
						<header>
							<ul class="containerRow">
								<li class="previousPage' . ($notAtStart ? '' : ' disabled') . '">
									<a' . ($notAtStart ? (' href="#abo' . ($i-1) . '"') : '') . ' title="Previous page, please!" ' . ($notAtStart ? ('tabindex="' . ++$tabIndex) . '"' : '') . '>
										<span>Prev</span>
									</a>
								</li><!-- previousPage ends -->
								<li class="nextPage' . ($notAtEnd ? '' : ' disabled') . '">
									<a' . ($notAtEnd ? (' href="#abo' . ($i+1) . '"') : '') . ' title="Next page, please!" ' . ($notAtEnd ? ('tabindex="' . ++$tabIndex) . '"' : '') . '>
										<span>Next</span>
									</a>
								</li><!-- nextPage ends -->
			...
			echo'
							...
							<div class="containerColumn">
								...
								<div class="containerRow gridLayout iconsBar">
									...
									<a class="disabled videopresentation" ' . (false ? 'href="?#abo0"' : '') . ' target="_blank" title="View my video presentation!" aria-labelledby="View my video presentation!" tabindex="' . ++$tabIndex . '"></a>
									<a class="disabled download" ' . (false ? 'href="?#abo0"' : '') . ' title="Go to the Download page for my curriculum vitae and cover letter!" aria-labelledby="Go to the Download page for my curriculum vitae and cover letter!" tabindex="' . ++$tabIndex . '"></a>
									<a class="disabled facebook" ' . (false ? 'href="?#abo0"' : '') . ' target="_blank" title="I like individuality and getting a Facebook account just means I follow the flow! I only care about document flow!" aria-labelledby="I like individuality and getting a Facebook account just means I follow the flow! I only care about document flow!" tabindex="' . ++$tabIndex . '"></a>
									<a class="disabled youtube" ' . (false ? 'href="?#abo0"' : '') . ' target="_blank" title="I will get a YouTube account and it will be used for making videos about software engineering!" aria-labelledby="I will get a YouTube account and it will be used for making videos about software engineering!" tabindex="' . ++$tabIndex . '"></a>
									<a class="disabled twitter" ' . (false ? 'href="?#abo0"' : '') . ' target="_blank" title="I will not get a Twitter account because of the negative aspects it has on society and people\'s interaction with others. Also, people like the Kardashians and Biebers can be found there! Do I need to say more?" aria-labelledby="I will not get a Twitter account because of the negative aspects it has on society and people\'s interaction with others. Also, people like the Kardashians and Biebers can be found there! Do I need to say more?" tabindex="' . ++$tabIndex . '"></a>
								</div><!-- containerRow ends -->
							</div><!-- containerColumn ends -->
