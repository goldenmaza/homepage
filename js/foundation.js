...
function toggleTarget() {
    ...
    if (document.getElementById("navigationBar").classList.contains("showing") === true) {
        document.getElementById("navigationBar").classList.remove("showing");
        document.getElementById("navigationHandler").classList.remove("showing");
    }
    else {
        document.getElementById("navigationBar").classList.add("showing");
        document.getElementById("navigationHandler").classList.add("showing");
    }
}
